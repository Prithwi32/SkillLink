        ...
        <div className="flex-1 pt-8">
                  <Tabs defaultValue="approved" className="h-full">
                    <TabsList className="mb-6 text-blue-600 p-1 rounded-lg shadow-sm bg-gray-100">
                      <TabsTrigger value="approved"   className="data-[state=active]:text-white data-[state=active]:bg-blue-600">
                        Approved
                        </TabsTrigger>
                      <TabsTrigger value="inReview"  className="data-[state=active]:text-white data-[state=active]:bg-blue-600">
                        In Review
                        </TabsTrigger>
                    </TabsList>
