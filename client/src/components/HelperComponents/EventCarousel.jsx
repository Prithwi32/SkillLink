    ...
    <div className="flex w-full flex-wrap items-center justify-center cursor-pointer gap-5">
      {topEvents.slice(0, 3).map((event, index) => (
        <Card
          ...
          key={index}
          className="p-6 white rounded-3xl shadow-blue-100 border border-blue-100 shadow-md lg:max-w-md w-full hover:shadow-lg hover:shadow-blue-200 hover:scale-[1.01] transition-all"
        >
