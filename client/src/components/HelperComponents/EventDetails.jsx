...
//       if (isEndTime && new Date(dateObj) < new Date(`${date}T${startTime}`)) {
//         // If the end time is earlier than the start time, increment the day
//         dateObj.setDate(dateObj.getDate() + 1);
//       }

//       const utcDate = new Date(dateObj.getTime() + 5.5 * 60 * 60 * 1000);
