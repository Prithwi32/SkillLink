...
export function EventCreationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const eventData = {
      ...
      start_time: `${eventDetails.date}T${eventDetails.startTime}${eventDetails.startPeriod === "PM" ? "PM" : "AM"}`,
      end_time: `${eventDetails.date}T${eventDetails.endTime}${eventDetails.endPeriod === "PM" ? "PM" : "AM"}`,
