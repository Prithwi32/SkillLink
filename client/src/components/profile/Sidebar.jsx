...
const navItems = [
  ...
  },
  {
    id: "review",
    label: "Review",
    icon: "M14 9a2 2 0 0 1-2 2H6l-4 4V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2z M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1",
  },
];
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        >
          <span className="text-black">Skill</span>Link
        </button>
