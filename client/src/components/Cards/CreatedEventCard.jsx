...
export const CreatedEventCard = ({ event, status, onDelete }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col">
      ...
      {status === "scheduled" ? (
        <div className="p-6 mt-auto">
          <button
            ...
            onClick={() => navigate(`/userDashboard/events/${event_id}`)}
          >
            View Details
          </button>
          <button
        ...
        <div
          className={`p-6 py-2 px-4 rounded-bl-md rounded-br-md text-center ${
            status === "canceled"
