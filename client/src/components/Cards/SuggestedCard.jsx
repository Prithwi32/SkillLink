...
const instructors = [
  {
    ...
    rating: 4.5,
    description:
      "Product designer with a passion for creating beautiful and functional user interfaces. Experienced in working with cross-functional teams and delivering high-quality designs.",
    badges: ["clothes", "stem"],
  },
  {
    name: "Jesus Weiss",
    avatar:
      "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=400&h=400&auto=format&fit=crop&q=80",
    rating: 4.8,
    description:
      "Tech enthusiast and gadget lover. Always exploring new technologies and sharing knowledge with the community.",
  ...
  },
  {
    ...
    rating: 4.2,
    description:
      "Adventure seeker and nature photographer. Love exploring mountains and capturing beautiful moments.",
